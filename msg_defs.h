// Commands for Tactical Repeater communication
...
#define CMD_WRITE_STINGER           17
#define CMD_WRITE_STINGER_SCHED     18
...
#define CMD_PLAYBACK_STATUS			69
#define CMD_DEFAULT_STATE_SET		83
#define CMD_RESP_MISC_INFO			89
...
// Stinger command
#define CMD_STINGER_1 'r'
#define CMD_STINGER_2 'x'
#define CMD_WRITE_STINGER_LEN 12 // 8 bytes + 2 for message ID+ 2 for CRC
// Write 8 byte Stinger schedule command
#define CMD_STINGER_SCHEDULE_1 'r'
#define CMD_STINGER_SCHEDULE_2 'z'
#define CMD_WRITE_STINGER_SCHEDULE_LEN 20 // 16 bytes + 2 for message ID+ 2 for CRC
...
// Load SD Encryption key: DP command
#define CMD_LOAD_SD_ENCRYPT_KEY_1 'd'
#define CMD_LOAD_SD_ENCRYPT_KEY_2 'p'
#define CMD_LOAD_SD_ENCRYPT_LEN 20
// Response to Load SD Key: TP response
#define RESP_LOAD_SD_ENCRYPT_KEY_1 't'
#define RESP_LOAD_SD_ENCRYPT_KEY_2 'p'
#define RESP_LOAD_SD_ENCRYPT_LEN 4


// Playback Status Request: RS command
#define CMD_PLAYBACK_STATUS_REQ_1 'r'
#define CMD_PLAYBACK_STATUS_REQ_2 'q'
#define CMD_PLAYBACK_STATUS_REQ_LEN 4
// Start/Stop Playback Request: RP command
#define CMD_PLAYBACK_START_REQ_1 'r'
#define CMD_PLAYBACK_START_REQ_2 'p'
#define CMD_PLAYBACK_START_REQ_LEN 9
// Playback Status Request: ST response
#define RESP_PLAYBACK_STATUS_1 't'
#define RESP_PLAYBACK_STATUS_2 'p'
#define RESP_PLAYBACK_STATUS_LEN 17
